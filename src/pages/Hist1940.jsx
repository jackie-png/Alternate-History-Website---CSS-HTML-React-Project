    ...
    return (
        <div>
            ...
            <div className="section-container">
                ...
                <h2 id="event-1" className="event-header">
                ...
                <h2 id="event-2" className="event-header">The Pacific War, 6th December 1940</h2>
                ...
                <h2 id="event-3" className="event-header">Halifax Conference of December 1940</h2>
                ...
                <h2 id="event-4" className="event-header">Early German War Plans</h2>
                ...
                <h2 id="event-5" className="event-header">The Balkan Front, January 1941</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-6" className="event-header">Romanian Intervention in the Balkans, May 1941</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-7" className="event-header">The Western Winter Offensive, December 1941</h2>
                ...
                <h2 id="event-8" className="event-header">Operation Red Flood, December 1941</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-9" className="event-header">British and French Troops Step Foot in Northern Germany, January 1942</h2>
                ...
                <h2 id="event-10" className="event-header">German Liberation of the Home Front, February 1942</h2>
                ...
                <h2 id="event-11" className="event-header">Austria Defeats Italy, April 1942</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-12" className="event-header">The Spring Western Offensive, April 1942 - April 1943</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-13" className="event-header">Iberian Liberation, May 1943</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-14" className="event-header">The Fall of the Commune of France, 2nd June 1943</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-15" className="event-header">Operation Sea Lion, 23rd August 1943 - 31st September 1943</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-16" className="event-header">The Autumn Eastern Offensive, September 1943</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-17" className="event-header">The Third Weltkrieg, 7th November 1943</h2>
                <div className="paragraph-container">
                ...
                <div className="footer">
                    <button className="next-button" onClick={() => nextYear()}>1944 - 1948</button>
                </div>
