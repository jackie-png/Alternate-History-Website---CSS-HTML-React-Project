    ...
    return (
        <div>
            ...
            <div className={articleStyle.section_container}>
                ...
                <h2 id="event-1" className={articleStyle.event_header}>Continuation of the War in the Pacific, January 1948</h2>
                ...
                <h2 id="event-2" className={articleStyle.event_header}>Invasion of Insulindia and the Philippines, May 1948</h2>
                <div className={articleStyle.paragraph_container}>
                ...
                <h2 id="event-3" className={articleStyle.event_header}>Operation Sunset, January 1949</h2>
                ...
                <h2 id="event-4" className={articleStyle.event_header}>Invasion of China, June 1949</h2>
                <div className={articleStyle.paragraph_container}>
                ...
                <h2 id="event-5" className={articleStyle.event_header}>The End of the War in the Pacific, March 15th 1950</h2>
                <div className={articleStyle.paragraph_container}>
                ...
                <h2 id="event-6" className={articleStyle.event_header}>Second Invasion of the Caribbean, April 1950</h2>
                <div className={articleStyle.paragraph_container}>
                ...
                <h2 id="event-7" className={articleStyle.event_header}>Invasion of America, 26th Novmeber 1950</h2>
                <div className={articleStyle.paragraph_container}>
           ...
           <div className={articleStyle.year_header}>
                ...
                <h2 id="event-8" className={articleStyle.event_header}>Push Towards Washington D.C, April 1951</h2>
                <div className={articleStyle.paragraph_container}>
                ...
                <h2 id="event-9" className={articleStyle.event_header}>The Fall of America, 5th July 1951</h2>
                <div className={articleStyle.paragraph_container}>
                ...
                <h2 id="event-10" className={articleStyle.event_header}>The End of the Third Weltkrieg, 7th November 1951</h2>
                <div className={articleStyle.paragraph_container}>
                ...
                <div className={homepageStyle.footer}>
                    <button className={articleStyle.next_button} onClick={() => lastYear()}>1944 - 1948</button>
                    <button className={articleStyle.next_button} onClick={() => nextYear()}>Peace Treaties</button>
                </div>
            </div>
