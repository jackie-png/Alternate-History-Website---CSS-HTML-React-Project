    ...
    return (
        <div>
            ...
            <div className="section-container">
                ...
                <h2 id="event-1" className="event-header">The Push Towards the Urals, January 1944</h2>
                ...
                <h2 id="event-2" className="event-header">The Ottoman Lead Excursion into Central Asia</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-3" className="event-header">First Moves Against the Entante, November 1944</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-4" className="event-header">The Battle of the Atlantic and the Invasion of North Africa, January 1945</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-5" className="event-header">Invasion of the Kingdom of Canada, June 1945</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-6" className="event-header">Invasion of the Dominion of India, August 14th 1946</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-7" className="event-header">US Intervention into the Third Weltkrieg, 7th March 1947</h2>
                <div className="paragraph-container">
                ...
                <h2 id="event-8" className="event-header">The Fall of India, 26th June 1947</h2>
                <div className="paragraph-container">
                ...
                <div className="footer">
                    <button className="next-button" onClick={() => lastYear()}>1940 - 1944</button>
                    <button className="next-button" onClick={() => nextYear()}>1948 - 1951</button>
                </div>                
            </div>
